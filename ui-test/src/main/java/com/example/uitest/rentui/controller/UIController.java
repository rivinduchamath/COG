package com.example.uitest.rentui.controller;


import com.example.uitest.rentui.config.AccessToken;
import com.example.uitest.rentui.model.User;
    ...
    public String loadCustomers(Model model) {
        ...
        try {
            ResponseEntity<User[]> responseEntity =
                    restTemplate.exchange("http://localhost:8283/services/profiles", HttpMethod.GET, customerHttpEntity, User[].class);
