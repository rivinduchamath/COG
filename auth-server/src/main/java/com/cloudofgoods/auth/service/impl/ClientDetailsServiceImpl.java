    ...
    public ClientDTO saveClient(ClientDTO clientDTO) {
       OauthClientDetails oauthClientDetails=
               new OauthClientDetails(
                ...
                clientDTO.getScope(),
                clientDTO.getAccessTokenValidity(),
                clientDTO.getRefreshTokenValidity(),
                clientDTO.getResourceIds(),
                clientDTO.getAuthorizedGrantTypes(),
                clientDTO.getAuthorities(),
                clientDTO.getAdditionalInformation(),
                clientDTO.getAutoApprove());
        System.out.printf("ossssssssssss"+oauthClientDetails);
